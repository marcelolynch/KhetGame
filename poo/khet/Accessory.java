...
/**
 * Un {@code Accessory} puede ser un componente de una pieza del tablero
 * y tiene la caracteristica de poder recibir rayos de alguna direcci&oacute;n
 * y procesarlos de alguna manera (modificando eventualmente el estado del rayo).
 * 
 * Un accesorio tiene una orientacion dada por una {@link Direction}, que incide en
 * si puede o no procesar el {@link Beam} (segun la direccion que lleva este) 
 * 
 * @see {@link Direction}
 * @see {@link Beam}
 */
public abstract class Accessory implements Serializable {
	...
	/**
	 * Rota el accesorio (cambia la direccion en la que se orienta)
	...
	/**
	 * Indica si puede procesar un rayo como el que se pasa como p&aacute;ametro 
	 * (teniendo en cuenta, por ejemplo, la direcci&oacute;n del {@code Beam})
	 * @param beam - el rayo sobre el que se quiere consultar
	 * @return - <code>true</code> si el rayo puede ser recibido por el accesorio, <code>false</code> en caso contrario
	 */
