...
public class Pyramid extends Piece {
    ...
    /**
     * Cambia la direccion del laser en caso de que sea reflejado. Devuelve si el laser fue o no
     * reflejado.
     * 
     * @param beam laser que recibe y al que le cambia la direccion
     * @return <tt>true</tt> si el laser fue reflejado y su direccion cambio. <ff>false</ff> si el
     *         laser no fue reflejado.
     */
    @Override
