...
public class PyramidTest {
	...
	@Before
	public void setUp() {
		pyramid = new Pyramid(Team.RED, Direction.NORTH); // debería reflejar rayos dirigidos hacia el sur
														  // y hacía el oeste
	...
	public void testRotateClockwise() {
		pyramid.rotateClockwise(); // debería reflejar rayos con dirección hacia el oeste y hacia el norte
	...
	public void testRotateCounterClockwise() {
		pyramid.rotateCounterClockwise();// debería reflejar rayos con dirección hacia el este y hacia el sur
