...
public class AIMover implements CannonPositions, BoardDimensions {
	...
	/**
     * Genera un nuevo <code>Beam</code> desde el ca√±on rojo con la orientaciÛn inversa  y devuelve el efecto que tuvo el
    ...
    /**
     * Se encarga de generar un <code>Beam</code> desde el ca√±on rojo con la orientaciÛn inversa.
     * @param cannon
     * @return
     */
